```{r setup_city_catoost_m1, include=FALSE}
...
# model_smote <- NULL  # 預設為 NULL，防止找不到錯誤
...
validation_selected <- convert_to_numeric(validation_selected)
...
write.csv(city_results, "result_city_cat_m1.csv", row.names = FALSE)
